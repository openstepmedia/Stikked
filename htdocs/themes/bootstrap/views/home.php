            ...
            <div class="row">
                <div class="span5 recent">
                    <section>
                        ...
                        <ul class="breadcrumb">
                            <li><a href="">All</a> <span class="divider">/</span></li>
                            <li><a href="">Javascript</a> <span class="divider">/</span></li>
                            <li><a href="">HTML</a> <span class="divider">/</span></li>
                            <li><a href="">Ruby</a> <span class="divider">/</span></li>
                            <li><a href="">Python</a> <span class="divider">/</span></li>
                            <li><a href="">PHP</a></li>
                        </ul>
                        <ul class="unstyled">
                        <?php foreach($recent['pastes'] as $item) : ?>
                            <li>
                                ...
                                <div><a href=""><code><?php echo $item['lang'] ?></code></a></div>
                            </li>
                        <?php endforeach; ?>
                        </ul>
                    </section>
