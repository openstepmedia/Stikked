...
<section>
    <div class="row">
        <div class="span12">
            ...
            <div class="row">
                <div class="span10">
                    <div class="detail by"><?php echo lang('paste_from'); ?> <?php echo $name; ?>, <?php $p = explode(',', timespan($created, time()));
echo $p[0] ?> <?php echo lang('paste_ago'); ?>, <?php echo lang('paste_writtenin'); ?> <?php echo $lang; ?>.</div>
...
<?php } else { ?>
                ...
                <div class="span2">
<?php if ($show_tools) : ?>
                        <ul class="unstyled tools">
                            <li><a href="/edit/<?php echo $pid ?>" class="btn" id="edit"><i class="icon icon-edit"></i> Edit</a></li>
                            <li><a href="/delete/<?php echo $pid ?>" class="btn" id="delete"><i class="icon icon-trash"></i> Delete</a></li>
                        </ul>
<?php endif; ?>
                </div>
            </div>
...
<section>
    ...
    if (isset($replies) and !empty($replies)) {
        ...
        <table class="recent table table-striped table-bordered">
            ...
            echo $p[0]; ?> <?php echo lang('paste_ago'); ?>.</td>
                    </tr>
